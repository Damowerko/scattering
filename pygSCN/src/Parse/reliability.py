...
new_filename = "../../Data/Reliability/NyConsolidated2011-2013.csv"
out_filename = "reliability_Ny.csv"
...
with open(in_path + old_filename) as old_f, open(in_path + new_filename) as new_f, open(out_path + out_filename, 'w') as out_f:
    # parse the old and new files
    intervals = parse_old(csv.reader(old_f)) + parse_new(csv.reader(new_f))
