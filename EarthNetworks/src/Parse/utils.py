...
class HourlyDataset:
    def __init__(self, start: Tuple[int, int, int, int], files, delimiter=",", skipinitialspace=True):
        """
        ...
        """
        self.files = files
        self.stations = [HourlyStation(start, file, delimiter, skipinitialspace) for file in files]
...
class HourlyStation:
    def __init__(self, start: Tuple[int, int, int, int], file, delimiter=",", skipinitialspace=False):
        self.file = file
        self.reader = csv.DictReader(file, delimiter=delimiter, skipinitialspace=skipinitialspace)
